document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (!currentUser) { authStatus.textContent = 'You must be signed in.'; authStatus.style.color = '#d00'; setTimeout(() => location.href = 'signin.html', 1200); return; }
  if (currentUser.role !== 'admin') { authStatus.textContent = 'Access denied. Admin only.'; authStatus.style.color = '#d00'; setTimeout(() => location.href = 'index.html', 1500); return; }
